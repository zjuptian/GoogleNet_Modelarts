...
def parse_args():
    ...
    parser.add_argument('--network', default = 'inception_v1', type=str,
    ...
    parser.add_argument('--weight_decay', default=0.0004,
    ...
    # log file
    parser.add_argument('--log_name', default='googlenet.log',
